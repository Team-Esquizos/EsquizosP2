...
var learningController = require('../src/learning/learningController');
var courseLearningController = require('../src/learningCourse/courseLearningController');
...
router.route('/learning/get').get(learningController.getLearningsControllerFn);

router.route('/courseLearnings/addToCourse/:codCurso/:_id').post(courseLearningController.addLearningToCourseControllerFn);
router.route('/courseLearnings/remove/:codCurso/:_id').delete(courseLearningController.removeLearningFromCourseControllerFn);
router.route('/courseLearnings/getFromCourse/:codCurso').get(courseLearningController.getCourseLearningsControllerFn);
